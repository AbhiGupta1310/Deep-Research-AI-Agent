...
# Initializing TavilySearchAPIWrapper
# Note: It expects TAVILY_API_KEY in environment variables
_tavily_search = None

def get_tavily_search():
    global _tavily_search
    if _tavily_search is None:
        _tavily_search = TavilySearchAPIWrapper()
...
def format_search_query_results(
    ...
    try:
        ...
        # Fallback if gpt-4 encoding not found/supported in environment
...
def save_as_pdf(markdown_content: str, filename: str):
    """
    Converts markdown content to PDF and saves it to the specified filename.
    """
